...
4. Set the auto-exploitation level with the slider. Use the slider to choose which exploitation level you're comfortable with. A low exploitation level will give you light scanning and probing of the network. A high exploitation level will use credentials found and try to move laterally, escalate privileges in the network, and create shell sessions.
...
For more information on seed element types, see the [Concepts](explanation.md/#seed-elements) page.
...
5. Once added, it will create the seed element in the left hand side of the menu.
...
4. After installing, the Sentry agent should be live in the Sentry Agents table in the Config (Gear Icon) tab.
