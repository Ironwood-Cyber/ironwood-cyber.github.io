...
Welcome to the platform — this guide will help you get set up quickly so you can begin running assessments, reviewing findings, and integrating security into your workflow.
...
### Sign Up
To get started, create your account on our platform:

1. Visit [**the portal**](https://portal.ironwoodcyber.com/)
2. Enter your work email and basic information
...
You can create an organization before a license is setup. To do so, click on the drop down to the right of the Ironwood Cyber Portal and click on Create Organization.
