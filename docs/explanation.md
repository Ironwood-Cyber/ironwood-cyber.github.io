...
Sentry agents are created by Ironwood Cyber to facilitate secure internal assessments from our cloud Enlight™ engine. Each agent registers with a license and establishes an authenticated session with our cloud services.
